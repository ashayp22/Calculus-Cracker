...
// this is code from my previous system; it worked, but had some major flaws, causing me to switch
//how it worked: user completes form, sign in and redirect to new page; then, you enter data in a form and post it
//flaws: more than one person can't be using the website
//flaws: person kept getting signed out/booted
...
// });
//
// app.post("/signing", function(req, res) { //redirects to signup
//     res.render('signup', {message: null});
//     res.end();
// });
//
...
//                 //add to
//
//                 answers.push(jsonContent.equation);
//                 questions.push(equation);
//                 typeofq.push(type);
//
//
...
//                     answers.splice(0, answers.length - 10);
//                     questions.splice(0, questions.length - 10);
//                     typeofq.splice(0, typeofq.length - 10);
//                 }
//
//                 //after reading, we write
//
...
//                         // session saved
//                         console.log("saved");
//                         res.render('portal', {answer: jsonContent.equation, previous: message});
//                         res.end();
//                     });
//
//
...
// app.get("/home", function(req, res) {
//
// //logged in, now we render with database info
//
//     //check if post exists
//     var uid = firebase.auth().currentUser.uid.toString();
//
...
//                 console.log(message);
//
//                 res.render('portal', {answer: null, previous: message});
//                 // res.end();
//             });
//
//         } else {
...
//
//             db.collection('users').doc(uid).set(data).then( ref => {
//                 res.render('portal' , {answer: null, previous: null});
//                 // res.end();
//             });
//         }
//     }).catch(function(error) {
